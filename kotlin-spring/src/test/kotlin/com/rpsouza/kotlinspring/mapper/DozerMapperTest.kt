...
import com.rpsouza.kotlinspring.mapper.mocks.MockPerson
...
class DozerMapperTest {
    ...
    fun parserVOListToEntityListTest() {
        ...
        val outputList: List<Person> = DozerMapper.parseListObjects(inputObject!!.mockVOList(), Person::class.java)
